...
export const metadata: Metadata = {
  ...
  description:
    "How The Strongest labels content evidence: strong, moderate, and limited research — plus coaching consensus, historical method, and heuristic. Research evidence stays separate from expert practice.",
