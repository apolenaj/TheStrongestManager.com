...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy placeholder for The Strongest — draft for professional legal review, not an approved policy.",
    ...
    <MarketingContainer>
      ...
      <div className="mt-8 max-w-2xl space-y-6 text-sm leading-relaxed text-[var(--color-muted)]">
        ...
        <section className="space-y-2">
          ...
          <p>
            The Strongest is a performance training product. It does not
