...
export const metadata: Metadata = {
  title: "Terms of Use",
  description:
    "Terms of Use placeholder for The Strongest — draft for professional legal review, not approved terms.",
  ...
  return (
    <MarketingContainer>
      <PageIntro
        eyebrow="Legal"
        title="Terms of Use"
        description="Intended conditions for using The Strongest. This page is a product placeholder — not legal advice and not approved terms of service."
      />
      ...
      <div className="mt-8 max-w-2xl space-y-6 text-sm leading-relaxed text-[var(--color-muted)]">
        ...
        <section className="space-y-2">
          ...
          <p>
            The Strongest provides training, technique, and related
