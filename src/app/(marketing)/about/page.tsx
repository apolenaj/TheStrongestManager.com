...
const PAGE_TITLE = "About Joe Apolenar — The Strongest Manager";
const PAGE_DESCRIPTION =
  "Joe Apolenar: natural IPF powerlifter (−120 kg), former 155 kg athlete turned 115 kg competitor, retail operations manager, and full-stack builder of The Strongest Manager.";
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24 lg:py-28">
          ...
          <p className="mt-8 max-w-prose text-base leading-relaxed text-zinc-400 sm:text-lg">
            The Strongest Manager is not just a fitness brand. It is the
