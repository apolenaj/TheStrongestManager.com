...
export const metadata: Metadata = {
  ...
  description:
    "Estimated 1RM, plate loading, DOTS, volume, attempt planning, and training max — useful tools that lead into TheStrongestManager without overpromising precision.",
