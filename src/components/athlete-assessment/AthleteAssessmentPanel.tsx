import type { AthleteAssessmentSnapshot } from "@/domain/athlete-assessment";

export function AthleteAssessmentPanel({
  snapshot,
}: {
  snapshot: AthleteAssessmentSnapshot;
}) {
  return (
      ...
      <dl className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <dd className="mt-1 text-sm">
            {snapshot.selfLabel} · {snapshot.notFullLabel}
          </dd>
        </div>
        <div>
          <dt className="text-xs uppercase tracking-wide text-[var(--color-muted)]">
